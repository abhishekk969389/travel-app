...
export type TourPackageDetailsLabels = NonNullable<TravelTourPackagesPageData["detailLabels"]>;
export type TourPackageSidebarBanner = NonNullable<TourPackageDetails["sidebarBanner"]>;
