...
import type { TravelPrivacyPolicyData } from "@/data/index";

interface PrivacySecProps {
  data?: TravelPrivacyPolicyData;
}

export default function PrivacySec({
  data: propData,
}: PrivacySecProps = {}) {
  const data: TravelPrivacyPolicyData = propData || travelData.privacyPolicy;
