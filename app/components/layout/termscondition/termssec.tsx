...
import type { TravelTermsConditionData } from "@/data/index";

interface TermsSecProps {
  data?: TravelTermsConditionData;
}

export default function TermsSec({
  data: propData,
}: TermsSecProps = {}) {
  const data: TravelTermsConditionData = propData || travelData.termsCondition;
