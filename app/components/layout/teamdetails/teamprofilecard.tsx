    ...
    <ScaleIn className="bg-[#0b1824] rounded-[22px] overflow-hidden shadow-2xl text-white flex flex-col h-full border">
      ...
      <div className="p-6 sm:p-7 flex flex-col flex-grow justify-between">
            ...
            {details.specialization && (
              <div className="flex items-center gap-3.5">
                ...
                <span className="font-normal text-slate-200 text-sm sm:text-base md:text-[18px]">
                  {detailsAny.specializationLabel || "Specialization:"} {details.specialization}
                </span>
              </div>
            )}
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 text-center">
            <div className="border-r border-slate-800/80 pr-2">
              ...
              <span className="block text-[11px] sm:text-xs font-normal text-slate-300 mt-0.5">
                {statsAny.yearsOfExperienceLabel || "Years of Experience"}
              </span>
            </div>
            <div className="pl-2">
              <span className="block text-2xl sm:text-3xl font-extrabold text-[#ff2e63] tracking-tight">
              ...
              <span className="block text-[11px] sm:text-xs font-normal text-slate-300 mt-0.5">
                {statsAny.toursCompletedLabel || "Tours Completed"}
              </span>
            </div>
          </div>
          <Link
          ...
          >
            <span>{details.buttonText || `${detailsAny.buttonTextPrefix || "Plan Your Trip with"} ${member.name.split(" ")[0]}`}</span>
