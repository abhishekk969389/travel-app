    ...
    <section className="relative w-full mt-8 sm:mt-10 md:mt-12 lg:mt-14 bg-white">
      <div className="relative z-10 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-4 mt-6 sm:mt-7">
            {data.tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 sm:px-6 py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 shadow-xs cursor-pointer ${
                    isActive
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7 items-start">
          {displayedDestinations.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="group relative bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden flex flex-col"
              >
                ...
                <div className="p-4 sm:p-4.5 flex flex-col flex-1 justify-between">
                  ...
                  <div className="flex items-center justify-between gap-2 mt-4 pt-3 border-t border-gray-100">
                    ...
                    <Link
                      href={item.href || "/destinations"}
                      aria-label={`Explore ${item.name}`}
                      className="w-8 h-8 rounded-full bg-[#ff2e63] text-white flex items-center justify-center shadow-md hover:bg-[#d91b4e] hover:scale-110 transition-all duration-200 shrink-0 ml-1"
                    >
