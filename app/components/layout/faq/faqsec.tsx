            ...
            <div className="relative z-10 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
                <FadeIn direction="up">
                    <div className="relative text-center max-w-2xl mx-auto mb-6">
                        ...
                        <div className="hidden lg:flex items-center absolute -right-32 xl:-right-44 -top-16 pointer-events-none select-none">
                            <div className="relative w-64 h-72">
                                <svg
                                    viewBox="0 0 260 280"
                                    fill="none"
                                    className="w-full h-full text-[#112d4e] overflow-visible"
                                >
            
                                    <path
                                        d="M 235 255 
                                         C 195 240, 160 230, 140 215 
                                         C 125 195, 110 168, 122 150 
                                         C 130 138, 142 142, 145 158 
                                         C 148 142, 160 138, 168 150 
                                         C 180 168, 165 195, 140 215 
                                         C 115 235, 75 220, 60 175 
                                         C 48 140, 10 135, 2 138"
                                        stroke="currentColor"
                                        strokeWidth="2"
                                        strokeDasharray="4 4"
                                        strokeLinecap="round"
                                ...
                                <div className="absolute left-[47%] top-[7%] text-[#112d4e] transform -rotate-[42deg] scale-125">
