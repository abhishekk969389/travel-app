            ...
            <div className="relative z-10 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-6">
                    ...
                    <FadeIn direction="left" className="lg:col-span-6 h-full">
                        <div className="relative overflow-hidden rounded-xl bg-[#09101d] shadow-2xl min-h-[540px] sm:min-h-[600px] lg:min-h-[640px] flex flex-col justify-between p-6 sm:p-8 md:p-10 group h-full">
                            {/* Background Image */}
                            <Image
                                src={hero.image}
                            ...
                            {/* Top Watermark Stamp Badge (Top-most Right Position) */}
                            <div className="absolute top-3 right-3 sm:top-4 sm:right-4 w-20 h-20 sm:w-24 sm:h-24 md:w-26 md:h-26 rounded-full border border-white/20 backdrop-blur-md bg-slate-900/40 flex items-center justify-center pointer-events-none p-1 z-20 shadow-xl">
                    ...
                    <StaggerContainer className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                        {features.map((feature: WhyChooseFeature) => (
                            <StaggerItem key={feature.id} className="h-full">
                                <div
                                    className="relative overflow-hidden rounded-xl bg-[#091120] shadow-xl min-h-[270px] sm:min-h-[290px] p-6 sm:p-7 flex flex-col justify-end gap-2.5 sm:gap-3 group transition-all duration-300 h-full"
                                >
